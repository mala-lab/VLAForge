...
class DeepfakeAbstractBaseDataset(data.Dataset):
    ...
    def collect_img_and_label_for_one_dataset(self, dataset_name: str):
        ...
        try:
            with open(os.path.join(self.config['dataset_json_folder'], dataset_name + '.json'), 'r', encoding='utf-8') as f:
    ...
    def __getitem__(self, index):
        ...
        Returns:
            ...
            and the mask tensor.
        """
        root_file = "/data/zhujiawen/"

        # Get the image paths and label
        image_path = root_file+self.data_dict['image'][index]
        ...
        return image_trans, label, landmarks_trans, mask_trans, xray_trans, patch_label_trans, clip_patch_label_trans, if_boundaries_trans, image_path
    ...
    def collate_fn(batch):
        ...
        images, labels, landmarks, masks, xrays, patch_labels, clip_patch_labels, if_boundaries, name = zip(*batch)
